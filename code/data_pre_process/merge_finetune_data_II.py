...
def merge_food_prompts_multi_model(filename1, filename2):
    ...
    for idx, data in tqdm(enumerate(data1), total=len(data1), desc="Loading test data"):
        ...
        try:
            ...
            categories2_list = categories2.split(', ')
        except:
            print(data2[idx])
...
with open('/map-vepfs/dehua/data/food2k_3_image_rank.json', 'w') as f:
...
# random.shuffle(total_prompts)
# with open('/map-vepfs/dehua/data/food2k_3_image_rank_fewshot4.json', 'w') as f:
#     json.dump(total_prompts, f, indent=4)  
...
# random.shuffle(total_prompts)
# with open('/map-vepfs/dehua/data/food2k_3_image_rank_fewshot8.json', 'w') as f:
#     json.dump(total_prompts, f, indent=4)  

# prompts_4 = merge_food_prompts_multi_model(data_dinov2[3], data_siglip[3])  

# total_prompts = prompts_4
# random.shuffle(total_prompts)
# with open('/map-vepfs/dehua/data/food2k_3_similarity_fewshot16.json', 'w') as f:
#     json.dump(total_prompts, f, indent=4)  
