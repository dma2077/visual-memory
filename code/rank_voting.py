...
if __name__ == "__main__":
    ...
    for dataset_name in dataset_names:
        ...
        input_file_3 = f"/map-vepfs/dehua/code/visual-memory/questions/{dataset_name}/siglip_test_5_mixedtrain_fewshot8.jsonl"
        output_file = f"/map-vepfs/dehua/code/visual-memory/answers/rank_voting/{dataset_name}/{dataset_name}_dinov2_softmax.jsonl"
        ...
        main(input_file_1=input_file_1, input_file_2=None, input_file_3=None, output_file=output_file, gold_answer_file_path=gold_answer_file_path, k1=k1)
