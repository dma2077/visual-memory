...
def get_llm_input(messages, tokenizer):
    ...
    for message in tqdm(messages, total=len(messages), desc="Processing messages"):
        ...
        prompt = tokenizer.apply_chat_template(message_new,
                                           tokenize=False,
...
def main(args):
    ...
    sampling_params = SamplingParams(temperature=0.0, top_p=0.95, max_tokens=2048, stop_token_ids=stop_token_ids)
