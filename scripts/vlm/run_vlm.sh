...
MODEL_PATH='/mnt/madehua/model/llava-hf/llava-1.5-7b-hf'
...
DATA_PROPORTION=1  # Use 1% of the data
...
"""
gpu_id=1
CUDA_VISIBLE_DEVICES=$gpu_id nohup sh scripts/run_vlm.sh > output/gpt_$gpu_id.log 2>&1 &
"""