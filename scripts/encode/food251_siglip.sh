...
file_path=/mnt/madehua/fooddata/FoodX-251/annot/val.txt
...
output_file=/mnt/madehua/fooddata/food_recognition/slip_retrieval/food251_results_softmax.jsonl

# Set the label file path
label_file=/mnt/madehua/fooddata/FoodX-251/annot/class_list.txt
