...
output_file=/map-vepfs/dehua/code/visual-memory/answers/food2k/food2k_results_softmax.jsonl
...
output_file=/map-vepfs/dehua/code/visual-memory/answers/food2k/food2k_train_results_softmax.jsonl
